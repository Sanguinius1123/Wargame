...
- **Combat formula:** Per-unit dice pool. Each unit rolls 2d6 ≥ To-Hit → 1 hit. Per hit, defender rolls 2d6 ≤ (defense − penetration) → saved; else 1 casualty or 1 HP. Both sides fire simultaneously, casualties removed after. See DESIGN.md for unit stats.
